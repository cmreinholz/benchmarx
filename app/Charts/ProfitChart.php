...
class ProfitChart extends BaseChart
{
    /**
    ...
    {
        $profit=db::table('responses')->selectRaw('count(CASE WHEN response BETWEEN 0 AND 100000 THEN 1 END ) as less_than_100000,
        ...
        return Chartisan::build()
            ...
            ->dataset( 'Revenue', [$profit[0]->less_than_100000,$profit[0]->between_100001_to_500000,$profit[0]->between_500001_to_1000000, $profit[0]->between_1000001_to_5000000, $profit[0]->between_5000001_to_25000000, $profit[0]->between_25000001_to_100000000])
